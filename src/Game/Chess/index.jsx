...
export default class App extends Component {
    constructor() {
        ...
        this.state = {
            ...
            whiteDisabled: false,
            count: 0,
            blackScore: 0, // 新增黑方得分，初始值为0
            whiteScore: 0 // 新增白方得分，初始值为0
        };
    }
    ...
    render() {
        return (
            <div className='wrapper'>
                {/* 新增展示黑方得分和白方得分的元素 */}
                <span>黑方得分: {this.state.blackScore}</span>
                <span>白方得分: {this.state.whiteScore}</span>
                <br />
            ...
            setTimeout(() => {
                if (result === 0) {
                    ...
                    this.setState((prevState) => ({
                        blackScore: prevState.blackScore + 1
                    }));
                    alert("黑色获胜");
                    this.resetClick();
                }
                if (result === 1) {
                    // 白方获胜，白方得分加1
                    this.setState((prevState) => ({
                        whiteScore: prevState.whiteScore + 1
                    }));
                    alert("白色获胜");
                    this.resetClick();
                }
